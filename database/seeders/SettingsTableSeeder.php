...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
        	['name' => 'name', 'value' => 'Tuhospedaje', 'type' => 'general'],
            ...
            ['name' => 'from_name', 'value' => 'Tuhospedaje', 'type' => 'email'],
            ...
            ['name' => 'key', 'value' => 'AIzaSyBr19LnTnibP2lPEUvDzo3iq71sUdPYhaY', 'type' => 'googleMap'],
