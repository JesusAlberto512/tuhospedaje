						...
						@if ($booking_details->host_fee)
							<div class="d-flex justify-content-between text-16">
								<div>
									...
									<i class="icon icon-question icon-question-sign" data-behavior="tooltip" rel="tooltip" aria-label="Tuhospedaje charges a fee to cover the cost (banking fees) of processing payment from the traveler."></i>

								</div>

								<div>
									<p class="pr-4">{!! optional($booking_details->currency)->symbol !!}{{ $booking_details->host_fee }}</p>
								</div>
							</div>
						@endif
