						...
						<form method="post" id="list_des" action="{{ url('listing/' . $result->id . '/' . $step) }}"  accept-charset='UTF-8'>
							...
							<div class="col-md-12 p-0 mt-4 mb-5">
								<div class="row m-0 justify-content-between">
									...
									<div class="mt-4">
										<button type="submit" class="btn btn-outline-primary text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3 pl-5 pr-5" id="btn_next"><i class="spinner fa fa-spinner fa-spin d-none" ></i>
